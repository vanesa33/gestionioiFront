...
export function imprimirIngreso(ingreso) {
  ...
  // 🔒 PROTECCIÓN CRÍTICA
  if (!ingreso || !ingreso.numorden) {
    console.error("Orden inválida para imprimir:", ingreso);
    alert("No se puede imprimir: la orden no es válida");
    return;
  }
  ...
  const contenido = `
    ...
    <table>
      <tr><th>Cliente</th><td>${client.nombre || ""} ${client.apellido || ""}</td></tr>
      <tr><th>Contacto</th><td>${client.telefono || "—"}</td></tr>
    </table>
    ...
    <table>
      ...
      <tr><th>Costo</th><td>$${ingreso.costo || "—"}</td></tr>
    ...
    <p style="font-size:12px;margin-top:10px">
      La garantía cubre únicamente defectos de reparación. No incluye daños por mal uso.
    </p>
    ...
    <div class="footer">
      M.T. de Alvear 2181 CABA — 011 3690-5558 · info@ioi-sa.com.ar
    </div>
  `;
